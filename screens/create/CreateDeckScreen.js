    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.formContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={[styles.inputCard, { backgroundColor: colors.blurView, shadowColor: colors.blurViewShadow }]}>
            <View style={styles.labelRow}>
              <Iconify icon="garden:translation-updated-fill-12" size={20} color="#F98A21" style={styles.labelIcon} />
          ...
          <View style={styles.buttonRowModern}>
            ...
            <TouchableOpacity
              ...
              disabled={loading}
            >
              <Text style={[styles.startButtonTextModern, typography.styles.button, { color: '#fff' }]}>{loading ? t('create.creating', 'Oluşturuluyor...') : t('create.create', 'Oluştur')}</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
